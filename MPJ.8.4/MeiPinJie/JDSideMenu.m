...
//    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(changeLeftBtn) name:@"change" object:nil];
...
//    [self.leftBtn addTarget:self action:@selector(showMenu) forControlEvents:UIControlEventTouchUpInside];
...
//        [blockSelf.containerView sendSubviewToBack:self.contentController.view];
